...
\shorterSection{Skills}
  ...
  \small
    \item{
     \textbf{Languages}{: Python, C++17, MATLAB, Bash, HTML/CSS, \LaTeX{}}
     \hfill
     \textbf{Development}{: Git, Linux, Unit Testing, Async}
    }
    \vspace{-5pt}
    \item{
     \textbf{Libraries}{: NumPy, Pandas, SciPy, Flask, C++ Standard Library (STL), Windows API, CUDA, SciKit-Learn, TensorFlow, OpenCV, Matplotlib}
    }
