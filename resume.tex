...
\shorterSection{Experience}
 \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Software Engineering Intern}{September 2022 - Present}
      \resumeItemListStart
        ...
        \resumeItem{Worked on a team of a dozen engineers to help fix bugs submitted by customers}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{Performed novel research to design and implement optimal algorithm for signal emitter localization}
      \resumeItem{Implemented sensor fusion algorithms (\textbf{Kalman filter}, TDOA) in \textbf{Python} to eliminate error in RF emitter location estimates from 2 meters to 0.5 meters}
    ...
    \resumeSubheading
      ...
      \resumeItem{Made use of \textbf{DMA} and CPU caching in order to transfer received data from FPGA to processor at over 1 GB/s}
