...
\begin{center}
  ...
  (416) 414 0515 $\vert$
  \href{https://gurevich.ca}{gurevich.ca} $\vert$
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Exceptional Performance}
          {Developed a high-throughput, multi-threaded C++ application for acquisition and processing of ultrasonic signals within strict operational requirements}
...
\shorterSection{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{Ultrasonic fluid flow meter}
     {A soft real-time utility that allows users to send and receive ultrasonic signals using USB hardware \\
