...
\shorterSection{Skills}
  ...
  \small
    \item{
     \textbf{Languages}{: Python, C++, C, MATLAB, Shell scripting, HTML/CSS}
     \hfill
     \textbf{Development}{: Git, Linux}
    }
    \vspace{-5pt}
    \item{
     \textbf{Libraries}{: NumPy, SciPy, Pandas, Matplotlib, Flask, C++ Standard Library (STL)}
    }
...
\shorterSection{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Software Engineer}{February 2018 - May 2019}
      \resumeItemListStart
        ...
        \resumeItem{Exceptional Performance}
          {Developed a high-throughput C++ application for acquisition and processing of ultrasonic signals within strict operational requirements}
