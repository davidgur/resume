...
\shorterSection{Skills}
  ...
  \small
    \item{
     \textbf{Languages}{: Python, C++17, MATLAB, Fortran 95, Bash, HTML/CSS, \LaTeX{}}
     \hfill
     \textbf{Development}{: Git, Linux, Async}
    }
    \vspace{-5pt}
    \item{
     \textbf{Libraries}{: NumPy, Pandas, SciPy, Flask, C++ Standard Library (STL), Windows API, CUDA, TensorFlow, OpenCV, Matplotlib}
    }
