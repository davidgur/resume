...
\begin{center}
  ...
  416 414 0515 $\vert$
  Website: \href{https://david.gurevich.ca}{david.gurevich.ca} $\vert$
...
\shorterSection{Skills}
  ...
  \small
    \item{
     \textbf{Languages}{: Python, C/C++, MATLAB, Bash, HTML/CSS, \LaTeX{}}
     \hfill
     \textbf{Development}{: Git, Linux, Unit Testing, Async}
    }
    \vspace{-5pt}
    \item{
     \textbf{Libraries}{: NumPy, Pandas, SciPy, Flask, C++ Standard Library (STL), Windows API, CUDA, SciKit-Learn, Tessearct OCR, Bokeh, Matplotlib}
    }
...
\shorterSection{Additional Experience \& Achievements}
  \resumeSubHeadingListStart
  \small
    \item{Placed top 25\% of students in the \textbf{Canadian Computing Competition}}
    \vspace{-5pt}
    \item{Achieved silver award in \textbf{The Queen's Commonwealth Essay Competition}}
    \vspace{-5pt}
    \item{Earned 100\% in TEJ3U Computer Engineering course for being the first person to develop a functioning version of Tetris for the Arduino}
    \vspace{-5pt}
    \item{Volunteer at local elementary school by controlling audio equipment (mixing boards, microphoens) for assemblies of 1000+ people}
    \vspace{-5pt}
    \item{Award-winning classical guitar player of over 10 years. Won multiple first place trophies at the \textbf{North York Music Festival}}
    \vspace{-5pt}
    \item{Elected as president of Computer Science club at Westmount Collegiate Institute for strong aptitude in mathematics and computer science}
  \resumeSubHeadingListEnd
%-------------------------------------------
\end{document}
