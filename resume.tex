...
\item{
        \textbf{Libraries}{: NumPy, SciPy, Pandas, PyTorch, TensorFlow, sklearn, Matplotlib, Flask, OpenCV}
    } \vspace{-5pt}
...
\shorterSection{Education}
  \resumeSubHeadingListStart
    \resumeSubheadingEd
      ...
      {\emph{Relevant Courses:} Intro to Machine Learning, Computational Linear Algebra, Stochastic Processes}
  \resumeSubHeadingListEnd
